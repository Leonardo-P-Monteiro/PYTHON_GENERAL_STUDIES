...
# Trabalhando com o zipflie: Empacotando arquivos.
with ZipFile(CAMINHO_COMPACTADO, 'w') as zip:
    for pasta_atual, subpasta, arquivos in os.walk(CAMINHO_ZIP_DIR):
        for arquivo in arquivos:
            print(arquivo)
            zip.write(Path(pasta_atual) / arquivo, arquivo)

# Trabalhando com o zipfile: Desempacotando os arquivos.
